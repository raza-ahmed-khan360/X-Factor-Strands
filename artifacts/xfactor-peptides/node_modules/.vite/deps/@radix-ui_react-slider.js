...
import {
  useSize
} from "./chunk-PPSMXZV4.js";
import {
  createCollection
} from "./chunk-ARWO2WQ4.js";
import {
  composeEventHandlers,
  createContextScope,
  useControllableState
} from "./chunk-QMA3IAIF.js";
import {
  Primitive
} from "./chunk-LSIVDQ22.js";
import {
  useComposedRefs
...
// ../../node_modules/.pnpm/@radix-ui+react-slider@1.4._90b1242b8bcb8eb0646f5a7a82b98821/node_modules/@radix-ui/react-slider/dist/index.mjs
...
var Slider = React3.forwardRef(
  (props, forwardedRef) => {
    ...
    const initialValuesRef = React3.useRef(values);
    React3.useEffect(() => {
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime2.jsx)(Collection.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime2.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index, isFormControl }) => (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
