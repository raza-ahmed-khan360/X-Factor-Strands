              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4 mt-6">
                    <div className="w-12 h-12 rounded-full bg-card border border-border flex items-center justify-center shrink-0 text-[#25D366]">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                        <path fillRule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-display font-semibold text-lg">Call or WhatsApp</h4>
                      <p className="text-muted-foreground mt-1 mb-1">Available for quick responses.</p>
                      <a href="tel:+14849032964" className="text-secondary hover:underline font-medium">+1 (484) 903-2964</a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-display font-semibold text-lg">Call Us</h4>
                      <p className="text-muted-foreground mt-1 mb-1">For urgent order enquiries.</p>
                      <a href="tel:+440000000000" className="text-secondary hover:underline font-medium">+44 (0) 20 7000 0000</a>
                    </div>
                  </div>
